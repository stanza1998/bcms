                ...
                <div className="uk-margin">
                  ...
                  <div className="uk-form-controls">
                    <select
                      ...
                      onChange={(e) => setUser({ ...user, supervisor: e.target.value })}
                      required
                    >
                      <option>Select...</option>
                  ...
                  <div className="uk-form-controls">
                    <div className="uk-margin">
                      ...
                      >
                        ...
                        <option value={USER_ROLES.HUMAN_RESOURCE}>Human Resources</option>
                        <option value={USER_ROLES.DIRECTOR}>Director</option>
                        <option value={USER_ROLES.MANAGING_DIRECTOR}>Managing Director</option>
